...
//								$result = $GLOBALS['pdo']->query('SELECT * from `serverconfig`');
	///							$worked = $result->fetch(PDO::FETCH_ASSOC);
  	...
  	<div>
			<?php
			$result1 = $GLOBALS['pdo']->prepare("SELECT count(*) FROM `ftopics` WHERE `reported` = '1'");
			$result1->execute();
			$threads = count($result1->fetchALL(PDO::FETCH_ASSOC));
			$result2 = $GLOBALS['pdo']->prepare("SELECT count(*) FROM `freplies` WHERE `reported` = '1'");
			$result2->execute();
			$posts = count($result2->fetchALL(PDO::FETCH_ASSOC));
			$result3 = $GLOBALS['pdo']->prepare("SELECT count(*) FROM `grpgusers` WHERE `reported` = '1'");
			$result3->execute();
			$profile = count($result3->fetchALL(PDO::FETCH_ASSOC));
			$result4 = $GLOBALS['pdo']->prepare("SELECT count(*) FROM `maillog` WHERE `reported` = '1'");
			$result4->execute();
			$mail = count($result4->fetch(PDO::FETCH_ASSOC));
			?>
             ...
             <a class="leftmenu" href="gmpanel.php"><img src="images/point.png" width=16 height=16 border=0> GM Guide</a>
             <?php echo ($user_class->admin == 1 ) ? '<a class="leftmenu" href="gmpanel.php?page=stafflog"><img src="images/point.png" width=16 height=16 border=0> Staff Log</a>' : ""; ?>
         	 <div class="space"></div>
             
             <div class="headbox">Bans</div>
             <a class="leftmenu" href="gmpanel.php?page=bans"><img src="images/point.png" width=16 height=16 border=0> Game Bans</a>
             <a class="leftmenu" href="gmpanel.php?page=fbans"><img src="images/point.png" width=16 height=16 border=0> Forum Bans</a>
             <a class="leftmenu" href="gmpanel.php?page=mbans"><img src="images/point.png" width=16 height=16 border=0> Mail Bans</a>
             <a class="leftmenu" href="gmpanel.php?page=freeze"><img src="images/point.png" width=16 height=16 border=0> Frozen Accts</a>           <a class="leftmenu" href="gmpanel.php?page=qa"><img src="images/point.png" width=16 height=16 border=0> Quick Ad Bans</a>
             <div class="space"></div>
             
             <div class="headbox">Reports</div>
			 <a class="leftmenu" href="gmpanel.php?page=reportthread"><img src="images/point.png" width=16 height=16 border=0> Threads </a>
             <a class="leftmenu" href="gmpanel.php?page=reportpost"><img src="images/point.png" width=16 height=16 border=0> Posts </a>
             <a class="leftmenu" href="gmpanel.php?page=reportprofile"><img src="images/point.png" width=16 height=16 border=0> Profile </a>
             <a class="leftmenu" href="gmpanel.php?page=reportmail"><img src="images/point.png" width=16 height=16 border=0> Mail</a>
             <div class="space"></div>
             
             <div class="headbox">Logs</div>
             <a class="leftmenu" href="gmpanel.php?page=attlog"><img src="images/point.png" width=16 height=16 border=0> Attack Log</a>
             <a class="leftmenu" href="gmpanel.php?page=marketlog1"><img src="images/point.png" width=16 height=16 border=0> Pt Market [Add]</a>
             <a class="leftmenu" href="gmpanel.php?page=marketlog2"><img src="images/point.png" width=16 height=16 border=0> Pt Market [Buy]</a>
             <a class="leftmenu" href="gmpanel.php?page=marketlog3"><img src="images/point.png" width=16 height=16 border=0> Pt Market [Rem.]</a>
             <a class="leftmenu" href="gmpanel.php?page=maillog"><img src="images/point.png" width=16 height=16 border=0> Mail Log</a>
             <a class="leftmenu" href="gmpanel.php?page=vaultlog"><img src="images/point.png" width=16 height=16 border=0> Vault Log</a>
             <div class="space"></div>
             
             <div class="headbox">Other</div>
             <a class="leftmenu" href="gmpanel.php?page=transfercheck"><img src="images/point.png" width=16 height=16 border=0> Transfer Checks</a>
             <a class="leftmenu" href="gmpanel.php?page=5050check"><img src="images/point.png" width=16 height=16 border=0> 50/50 Checks</a>
             <a class="leftmenu" href="gmpanel.php?page=accountcheck"><img src="images/point.png" width=16 height=16 border=0> Account Checks</a>
             <div class="space"></div>
