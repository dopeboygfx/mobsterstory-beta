							...
							<div>
								...
								<div class="ui small inverted vertical menu" width="80px;">
									<div class="item">
										...
										<div class="menu">
											<a class="item" a href="index.php">Home</i><i class="home icon"></i></a>
											<a class="item" href="city.php"><!_-cityname-_!></i><i class="plane icon"></i></a>
											<a class="item" href="bank.php">Bank<i class="university open icon"></i></a>
											<a class="item" href="gym.php">Gym<i class="shield alternate icon"></i></a>
											<a class="item" href="crime.php">Crime<i class="crosshairs open icon"></i></a>
											<a class="item" href="<? echo ($user_class->gang == 0) ? "creategang.php" : "gang.php"; ?>">Your Gang<i class="users icon"></i></a>
											<a class="item" href="gangmassmail.php">Gang Mail<i class="envelope open icon"></i></a>
											<a class="item" href="jail.php">Jail <!_-jail-_!><i class="lock icon"></i></a>
											<a class="item" href="hospital.php">Hospital <!_-hospital-_!><i class="h icon"></i></a>
											<a class="item" href="spylog.php">Spy Log<i class="spy icon"></i></a>
											<a class="item" href="classifieds.php">Classified Ads<i class="newspaper icon"></i></a>
											<a class="item" href="chat.php">Chat - BETA<i class=" chat icon"></i></a>
											<a class="item" href="#" target="_blank">Forums<i class=" comment outline icon"></i></a>
											<a class="item">Contact List<i class="book icon"></i></a>
											<div class="item">
												<div class="header">Account</div>
												<div class="menu">
													<a class="item" href="index.php?action=logout">Logout</a>
													<a class="item" href="preferences.php">Change Preferences</a>
													<a class="item" href="cpassword.php">Change Password</a>
